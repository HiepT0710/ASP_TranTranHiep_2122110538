...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Restaurant>().HasIndex(r => r.OwnerId).IsUnique();
        ...
        modelBuilder.Entity<OrderStatusHistory>()
            ...
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<OrderStatusHistory>().HasIndex(h => h.OrderId);
        modelBuilder.Entity<OrderPayment>()
            .HasOne(p => p.Order)
            .WithMany(o => o.Payments)
            .HasForeignKey(p => p.OrderId)
            .OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<OrderPayment>().Property(p => p.Amount).HasPrecision(18, 2);
        ...
        modelBuilder.Entity<CartItem>()
            ...
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<CartItem>().HasIndex(c => new { c.UserId, c.FoodId }).IsUnique();
        ...
        modelBuilder.Entity<OrderMessage>()
            ...
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<OrderMessage>().HasIndex(m => m.OrderId);
        modelBuilder.Entity<PushSubscription>()
            .HasOne(s => s.User)
            .WithMany(u => u.PushSubscriptions)
            .HasForeignKey(s => s.UserId)
            .OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<PushSubscription>().HasIndex(s => s.Endpoint).IsUnique();
        ...
        modelBuilder.Entity<Promotion>()
            ...
            .OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<Promotion>().HasIndex(p => new { p.Scope, p.RestaurantId, p.FoodId, p.IsActive });
